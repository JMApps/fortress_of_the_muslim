...
class DatabaseChaptersService {
  static final DatabaseChaptersService _instance = DatabaseChaptersService.internal();

  factory DatabaseChaptersService() => _instance;
  static Database? _db;
  ...
  DatabaseChaptersService.internal();
