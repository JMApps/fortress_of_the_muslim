...
import 'package:fortress_of_the_muslim/presentation/widgets/chapter_content_day_night_bottom_buttons.dart';
import 'package:provider/provider.dart';

class ChapterContentDayNightItem extends StatelessWidget {
  const ChapterContentDayNightItem({
    Key? key,
    required this.item,
  }) : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            ChapterContentDayNightBottomButtons(item: item),
          ],
        ),
      ),
    );
